...
public class ExampleApp : MonoBehaviour
{
    ...
    {
        IWebRequestReponse webRequestResponse = await object2DApiClient.ReadObject2Ds(object2D.EnviromentGUID);
        ...
        switch (webRequestResponse)
        {
            case WebRequestData<List<Object2D>> dataResponse:
                ...
                object2Ds.ForEach(object2D => Debug.Log(object2D.GUID));
    ...
    public async void CreateObject2D()
    {
        ...
        switch (webRequestResponse)
        {
            case WebRequestData<Object2D> dataResponse:
                object2D.GUID = dataResponse.Data.GUID;
                // TODO: Handle succes scenario.
                break;
            case WebRequestError errorResponse:
                string errorMessage = errorResponse.ErrorMessage;
